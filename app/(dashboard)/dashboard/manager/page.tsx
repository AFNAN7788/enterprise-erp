...
const managerLinks = [
  { label: "Team Overview", href: "/dashboard/manager/teams", icon: Users },
  { label: "Projects", href: "/dashboard/projects", icon: FolderKanban },
  { label: "Tasks", href: "/dashboard/employee/tasks", icon: ListTodo },
  { label: "Leave Management", href: "/dashboard/manager/leave", icon: CalendarOff },
  { label: "Performance Reviews", href: "/dashboard/manager/performance", icon: Star },
];
    ...
    <div className="flex flex-col gap-6">
      <div className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-[var(--muted-foreground)]">
          Welcome back, <span className="font-semibold text-[var(--foreground)]">{profile?.full_name ?? "Manager"}</span>.
        </p>
      </div>
